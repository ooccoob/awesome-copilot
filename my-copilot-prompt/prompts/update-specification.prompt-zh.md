---
代理人：“代理人”
描述：“更新解决方案的现有规范文件，根据新要求或任何现有代码的更新针对生成式 AI 消耗进行优化。”
...
您的目标是根据新要求或对任何现有代码的更新来更新现有规范文件 `${file}`。
...
规范应保存在 [/spec/](/spec/) 目录中，并根据以下约定命名：`[a-z0-9-]+.md`，其中名称应描述规范的内容并以高级目的开始，高级目的是[架构、工具、数据、基础设施、流程、架构或设计]之一。
