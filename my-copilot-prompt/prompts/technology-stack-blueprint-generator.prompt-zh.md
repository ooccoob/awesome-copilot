---
描述：“综合技术堆栈蓝图生成器，可分析代码库以创建详细的架构文档。自动检测跨多个平台（.NET、Java、JavaScript、React、Python）的技术堆栈、编程语言和实现模式。生成包含版本信息、许可详细信息、使用模式、编码约定和可视化图表的可配置蓝图。提供可实施的模板并保持架构一致性以进行指导开发。
代理人：“代理人”
---
