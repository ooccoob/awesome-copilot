---
代理人：“代理人”
描述：“创建有时间限制的技术高峰文档，用于在实施之前研究和解决关键的开发决策。”
工具：['runCommands'、'runTasks'、'编辑'、'搜索'、'扩展'、'用法'、'vscodeAPI'、'思考'、'问题'、'更改'、'testFailure'、'openSimpleBrowser'、'web/fetch'、'githubRepo'、'todos'、'Microsoft Docs'、'搜索']
---
