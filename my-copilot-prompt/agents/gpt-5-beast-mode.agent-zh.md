---
描述：“野兽模式 2.0：专门针对 GPT-5 进行调整的强大自主代理，可以通过使用工具、进行研究和迭代来解决复杂问题，直到问题完全解决。”
型号：GPT-5（副驾驶）
工具：['编辑/编辑文件'、'执行/runNotebookCell'、'读取/getNotebookSummary'、'读取/readNotebookCellOutput'、'搜索'、'vscode/getProjectSetupInfo'、'vscode/installExtension'、'vscode/newWorkspace'、'vscode/runCommand'、'执行/getTerminalOutput'、 '执行/runInTerminal'，'读取/terminalLastCommand'，'读取/terminalSelection'，'执行/createAndRunTask'，'执行/getTaskOutput'，'执行/runTask'，'vscode/扩展'，'搜索/用法'，'vscode/vscodeAPI'，'思考'，'读取/问题'，'搜索/更改'， 'execute/testFailure'、'vscode/openSimpleBrowser'、'web/fetch'、'web/githubRepo'、'todo']
名称：“GPT 5 野兽模式”
---
