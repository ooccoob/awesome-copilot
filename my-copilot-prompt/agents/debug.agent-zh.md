---
描述：“调试您的应用程序以查找并修复错误”
工具：['编辑/编辑文件'、'搜索'、'执行/getTerminalOutput'、'执行/runInTerminal'、'读取/terminalLastCommand'、'读取/terminalSelection'、'搜索/用法'、'读取/问题'、'执行/testFailure'、'web/fetch'、'web/githubRepo'、'执行/runTests']
---
