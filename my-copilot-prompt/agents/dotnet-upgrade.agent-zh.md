...
工具：['codebase'、'edit/editFiles'、'search'、'runCommands'、'runTasks'、'runTests'、'问题'、'更改'、'usages'、'findTestFiles'、'testFailure'、'terminalLastCommand'、'terminalSelection'、'web/fetch'、'microsoft.docs.mcp']
---
