---
描述：“用于创建高质量提示的专家提示工程和验证系统 - 由 microsoft/edge-ai 为您提供”
工具：['codebase'、'edit/editFiles'、'web/fetch'、'githubRepo'、'问题'、'runCommands'、'search'、'searchResults'、'terminalLastCommand'、'terminalSelection'、'用法'、'terraform'、'Microsoft Docs'、'context7']
---
