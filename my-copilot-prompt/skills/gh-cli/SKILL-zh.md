---
名称：gh-cli
描述：GitHub CLI (gh) 全面参考存储库、问题、拉取请求、操作、项目、发布、要点、代码空间、组织、扩展以及命令行中的所有 GitHub 操作。
---

# GitHub CLI (gh)

GitHub CLI (gh) 的综合参考 - 从命令行与 GitHub 无缝协作。
...
| __代码0__ |过滤 JSON 输出 |
| __代码0__ |输出指定字段的JSON |
| __代码0__ |使用 Go 模板格式化 JSON |
| __代码0__ |在浏览器中打开 |
| __代码0__ |进行额外的 API 调用 |
| __代码0__ |显示详细输出 |
| __代码0__ |显示调试输出 |
| __代码0__ |最大 API 请求持续时间 |
| __代码0__ |缓存控制（默认、强制、旁路）|
