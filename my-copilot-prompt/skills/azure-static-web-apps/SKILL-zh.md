---
名称：azure-static-web-apps
描述：帮助使用 SWA CLI 创建、配置和部署 Azure 静态 Web 应用。将静态站点部署到 Azure、设置 SWA 本地开发、配置 staticwebapp.config.json、将 Azure Functions API 添加到 SWA 或设置静态 Web 应用的 GitHub Actions CI/CD 时使用。
---
