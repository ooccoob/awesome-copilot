...
# 适用于 Python 的 Dataverse SDK — 实际用例和模板
...
- [Dataverse数据迁移](https://learn.microsoft.com/en-us/power-platform/architecture/key-concepts/data-migration/workflow-complex-data-migration)
