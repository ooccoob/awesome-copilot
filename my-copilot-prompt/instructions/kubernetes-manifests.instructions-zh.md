---
applyTo: 'k8s/**/*.yaml,k8s/**/*.yml,清单/**/*.yaml,清单/**/*.yml,部署/**/*.yaml,部署/**/*.yml,charts/**/templates/**/*.yaml,charts/**/templates/**/*.yml'
描述：“Kubernetes YAML 清单的最佳实践，包括标签约定、安全上下文、pod 安全、资源管理、探测和验证命令”
---
