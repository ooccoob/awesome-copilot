---
applyTo: ".copilot-tracking/changes/20250811-translate-md-files-changes.md"
---

<!-- markdownlint-disable-file -->

# 20250811 Markdown 文件本地化翻译任务计划

## 目标

将 `chatmodes`、`instructions`、`prompts` 目录下所有 `.md` 文件翻译为简体中文，存放于 `localization/zh-cn` 对应目录。每个文件为独立任务，状态实时追踪。
...
- [x] accesibility.chatmode.md
- [x] api-architect.chatmode.md
- [x] azure-principal-architect.chatmode.md
- [x] azure-saas-architect.chatmode.md
- [x] azure-verified-modules-bicep.chatmode.md
- [x] azure-verified-modules-terraform.chatmode.md
- [x] blueprint-mode.chatmode.md
- [x] clojure-interactive-programming.chatmode.md
- [x] critical-thinking.chatmode.md
- [x] csharp-dotnet-janitor.chatmode.md
- [x] debug.chatmode.md
- [x] demonstrate-understanding.chatmode.md
- [x] electron-angular-native.chatmode.md
- [x] expert-dotnet-software-engineer.chatmode.md
- [x] expert-react-frontend-engineer.chatmode.md
- [x] gilfoyle.chatmode.md
- [x] implementation-plan.chatmode.md
- [x] janitor.chatmode.md
- [x] mentor.chatmode.md
- [x] meta-agentic-project-scaffold.chatmode.md
- [x] microsoft-study-mode.chatmode.md
- [x] microsoft_learn_contributor.chatmode.md
- [x] ms-sql-dba.chatmode.md
- [x] plan.chatmode.md
- [x] planner.chatmode.md
- [x] playwright-tester.chatmode.md
- [x] postgresql-dba.chatmode.md
- [x] prd.chatmode.md
- [x] principal-software-engineer.chatmode.md
- [x] prompt-builder.chatmode.md
- [x] prompt-engineer.chatmode.md
- [x] refine-issue.chatmode.md
- [x] rust-gpt-4.1-beast-mode.chatmode.md
- [x] semantic-kernel-dotnet.chatmode.md
- [x] semantic-kernel-python.chatmode.md
- [x] simple-app-idea-generator.chatmode.md
- [x] software-engineer-agent-v1.chatmode.md
- [x] specification.chatmode.md
- [x] task-planner.chatmode.md
- [x] task-researcher.chatmode.md
- [x] tdd-green.chatmode.md
- [x] tdd-red.chatmode.md
- [x] tdd-refactor.chatmode.md
- [x] tech-debt-remediation-plan.chatmode.md
- [x] Thinking-Beast-Mode.chatmode.md
- [x] voidbeast-gpt41enhanced.chatmode.md
- [x] wg-code-alchemist.chatmode.md
- [x] wg-code-sentinel.chatmode.md

---

## Instructions 目录

[x] a11y.instructions.md
[x] ai-prompt-engineering-safety-best-practices.instructions.md
[x] angular.instructions.md
[x] aspnet-rest-apis.instructions.md
[x] azure-functions-typescript.instructions.md
[x] azure-verified-modules-terraform.instructions.md
[x] bicep-code-best-practices.instructions.md
[x] blazor.instructions.md
[x] cmake-vcpkg.instructions.md
[x] containerization-docker-best-practices.instructions.md
[x] conventional-commit.prompt.md
[x] copilot-thought-logging.instructions.md
[x] csharp.instructions.md
[x] dart-n-flutter.instructions.md
...
- [x] nextjs-tailwind.instructions.md
- [x] nextjs.instructions.md
- [x] a11y.instructions.md
- [x] ai-prompt-engineering-safety-best-practices.instructions.md
- [x] angular.instructions.md
- [x] aspnet-rest-apis.instructions.md
...
- 所有文件均已翻译并放入正确的 `localization/zh-cn` 子目录
- 翻译准确，包含所需免责声明
